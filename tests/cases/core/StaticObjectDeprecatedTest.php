...
class StaticObjectDeprecatedTest extends \lithium\test\Unit {
	...
	public function testClassParents() {
		...
		$expected = ['lithium\core\StaticObjectDeprecated' => 'lithium\core\StaticObjectDeprecated'];
	...
	public function testMethodInvocationWithParameters() {
		$this->assertEqual(MockStaticObjectDeprecated::invokeMethod('foo'), []);
		$this->assertEqual(MockStaticObjectDeprecated::invokeMethod('foo', ['bar']), ['bar']);

		$params = ['one', 'two'];
		$this->assertEqual(MockStaticObjectDeprecated::invokeMethod('foo', $params), $params);
