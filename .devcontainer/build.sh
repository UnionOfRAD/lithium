...
apt-get update && export DEBIAN_FRONTEND=noninteractive \
    && apt-get -y install --no-install-recommends default-mysql-client git libicu-dev libmemcached-dev libmcrypt-dev libpq-dev netcat postgresql-client-13 vim zip zlib1g-dev
